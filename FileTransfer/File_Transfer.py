...
def Send():
    ...
    #icon
    image_icon1=PhotoImage (file="University-Project/FileTransfer/Images/send.png")
    window.iconphoto (False, image_icon1)

    Sbackground=PhotoImage (file="University-Project/FileTransfer/Images/sender.png")
    Label (window, image=Sbackground).place(x=-2, y=0)

    Mbackground=PhotoImage (file="University-Project/FileTransfer/Images/id.png")
...
def Receive():
    ...
    #icon
    image_icon1=PhotoImage (file="University-Project/FileTransfer/Images/receive.png")
    main.iconphoto (False, image_icon1)

    Hbackground=PhotoImage (file="University-Project/FileTransfer/Images/receiver.png")
    Label(main, image=Hbackground).place(x=-2, y=0)

    logo=PhotoImage (file='University-Project/FileTransfer/Images/profile.png')
    ...
    imageicon=PhotoImage(file="University-Project/FileTransfer/Images/arrow.png")
